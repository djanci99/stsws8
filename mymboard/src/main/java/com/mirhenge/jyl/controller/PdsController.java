...
public class PdsController {
	...
	public String pdsupload(
		...
		//String fupload = "C:\\ssafyupload";//상황에 따라 변경하도록 만들자.
		logger.info(": "+ fupload);
	...
	@RequestMapping(value = "pdsdetail.pdf", method = {RequestMethod.GET,RequestMethod.POST})
	public String pdsdetailpdf(int seq,Model model) throws Exception {
		logger.info("Welcome PDSController pdsdetailpdf! "+ new Date());
		    model.addAttribute("pdsPDF", jYLPDSService.getPDS(seq));
		return "pdsdetailView";
	}
