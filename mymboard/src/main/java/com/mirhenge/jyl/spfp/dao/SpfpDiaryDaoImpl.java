...
public class SpfpDiaryDaoImpl implements SpfpDiaryDao {
	...
	@Override
	public List<SpfpDiary> getMyDiaries(int team) {
		return  sqlSession.selectList(ns+"getMyDiaries", team);
	}

	@Override
	public List<SpfpDiary> getSpfpDiarys(String today) {
		return  sqlSession.selectList(ns+"getSpfpDiarys", today);
	}
