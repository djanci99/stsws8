 ...
 *
 */
public class PDFBuilders extends AbstractITextPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document doc,
		...
		List<SpfpDiary>  diarys = (List<SpfpDiary>)model.get("spfpPDFs");
		String today=(String)model.get("today");// 해당 년월일
		//경로
		String fontpath 
		...
		for(SpfpDiary diary: diarys) {
			doc.add(new Paragraph(diary.getWdate()+" 작성일"));
		...
		String fileName = URLEncoder.encode(today+"sdiaries","utf-8") + ".pdf";
