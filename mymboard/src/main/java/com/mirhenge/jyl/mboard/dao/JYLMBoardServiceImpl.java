...
public class JYLMBoardServiceImpl implements JYLMBoardService {
	...
	public void writeBbs(JYLMBoard mboard) {
		mboard.setRef(jYLMBoardDao.getRef());
	...
	public void reply(JYLMBoard mboard) throws Exception {
		mboard.setRef(jYLMBoardDao.getNextRef(mboard.getSeq()));
		mboard.setStep(jYLMBoardDao.getNextStep(mboard.getSeq()));
		mboard.setDepth(jYLMBoardDao.getNextDepth(mboard.getSeq()));
