...
public class JYLMBoardDaoImpl implements JYLMBoardDao {
	...
	@Override
	public int getRef() {
		return sqlSession.selectOne(ns+"getRef");
	}

	@Override
	public int getNextRef(int seq) {
		return sqlSession.selectOne(ns+"getNextRef",seq);
	}

	@Override
	public int getNextStep(int seq) {
		return sqlSession.selectOne(ns+"getNextStep",seq);
	}

	@Override
	public int getNextDepth(int seq) {
		return sqlSession.selectOne(ns+"getNextDepth",seq);
	}
