...
public class LoggingAspect {
	...
	@Before(value = "execution(* com.mirhenge.jyl..dao.*.*(..))")
	...
	@Around(value = "execution(* com.mirhenge.jyl..dao.*.*(..))")
...
//
//	@AfterReturning(value = "execution(* com.ssafy.edu.model..Board*.list*(..))", returning = "obj")
...
//	}
//
//	@AfterThrowing(value = "execution(* com.ssafy.edu.model..Board*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* com.ssafy.edu.model..Board*.list*(..))")
