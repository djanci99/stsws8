...
<tr>
<th>내용</th>
<td style="text-align: left"><textarea rows="20" cols="100" 
...
<div id="buttons_wrap2">
<span class="button blue">
	<button type="button" id="_btnReply" title="PDF">PDF 저장</button></span>
</div>
<form name="frmForm3" id="_frmForm3" method="get">
<input type="hidden" name="seq" value="${pds.seq}"/>
</form>
...
$("#_btnReply").click(function() {	
	...
	$("#_frmForm3").attr({ "target":"_self", "action":"pdsdetail.pdf" }).submit();
});
