...
<li><a href="#none" onclick="url_yutube();" title="YouTube">YouTube</a></li>
<li><a href="#none" onclick="url_spfpcal();" title="일지">일지</a></li>	
<li><a href="#none" onclick="url_myInfor();" title="내정보">내정보</a></li>	
</c:if>
...
<li><a href="#none" onclick="url_spfpcal();" title="일지">일지</a></li>	
<li><a href="#none" onclick="url_myInfor();" title="내정보">내정보</a></li>
<!-- <li><a href="#none" onclick="url_memInfor();" title="멤버정보">멤버정보</a></li> -->					
</c:if>
		</ul>
	</div>
</div>
