...
<c:if test="${cookie.kitri_id.value ne null}">
	<c:set var="idck" value=" checked"/>
	<c:set var="saveid" value="${cookie.kitri_id.value}"/>
</c:if>
<!DOCTYPE html>
<html lang="ko">
  <head>
  ...
  <c:if test="${not empty userinfo}">
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10 col-sm-12">
          <h2 class="my-3 py-3 shadow-sm bg-light text-center">
            <mark class="orange">KITRI 게시판 - Spring Web MVC &amp; Spring myBatis &amp; REST API</mark>
          </h2>
        </div>
