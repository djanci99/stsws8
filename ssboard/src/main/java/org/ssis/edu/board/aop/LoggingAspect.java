package org.ssis.edu.board.aop;
...
public class LoggingAspect {
	...
	@Before(value = "execution(* org.ssis.edu.board.model.mapper.Board*.*(..))")
	...
	@Around(value = "execution(* org.ssis.edu.board.model.mapper.Board*.*(..))")
	...
	@AfterReturning(value = "execution(* org.ssis.edu.board.model.mapper.Board*.list*(..))", returning = "obj")
...
//
//	@AfterThrowing(value = "execution(* org.ssis.edu.board.model..Board*.list*(..))", throwing = "exception")
//	public void afterThrowingMethod(JoinPoint joinPoint, Exception exception) {
//		logger.debug("afterThrowing call method : {}", joinPoint.getSignature());
//		logger.debug("exception : {}", exception);
//	}
//
//	@After(value = "execution(* org.ssis.edu.board.model..Board*.list*(..))")
