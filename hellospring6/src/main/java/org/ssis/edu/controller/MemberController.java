...
public class MemberController {
	...
	public String regiaf(@ModelAttribute MemberDto member)throws Exception {
	...
	@RequestMapping(value = "/login", 
			method = RequestMethod.POST)
	public String login(@ModelAttribute MemberDto member, HttpSession session)throws Exception {
